...
class resultclass:
    def __init__(self, root):
        ...
        lb1_makrs_ob=Label(self.root,text="Marks Obtained",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=280)
        ...
        btn_serach = Button(self.root,text='Search',font = ("goudy old style",15,"bold"),bg= "#03a9f4",fg="white",cursor ="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        ...
        #==========Button============   
        btn_submit = Button(self.root,text='Submit',font = ("times new roman",15,),bg= "lightgreen",activebackground="lightgreen",cursor ="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        ...
        #=========image=================
        self.bg_img = Image.open(resource_path("images/result.jpg"))
        self.bg_img = self.bg_img.resize((500,300))
        self.bg_img = ImageTk.PhotoImage(self.bg_img)

        self.lbl_bg = Label(self.root,image=self.bg_img).place(relx=0.57,rely=0.18)
            ...
            if self.var_name.get() == "":
                ...
                if row != None:
                    ...
                    if self.var_marks.get() == "" or self.var_full_marks.get() == "":
                        ...
                        return
                    per = f"{(int(self.var_marks.get())*100)/int(self.var_full_marks.get()):.2f}"
